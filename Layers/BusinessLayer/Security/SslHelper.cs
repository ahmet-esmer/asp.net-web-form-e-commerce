...
namespace BusinessLayer.Security
{
    public class SslHelper
    {
        ...
        public class DefaultApplication : IApplication
        {
            ...
            {
                HttpContext.Current.Response.Redirect(uri.OriginalString);
            }
            ...
            public Uri ResolvePossibleAppRelativeUri(Uri possibleAppRelativeUri)
            {
                ...
                string urlWithoutQueryString =
                    SslHelper.StripQueryStringFromRelativeUrl(possibleAppRelativeUri, out queryString);
        ...
        public void SwitchToSsl()
        {
            if (SslIsEnabledInConfig())
                Redirect(new Uri(Application.CurrentRequestUri.PathAndQuery, UriKind.Relative),
        ...
        public static string StripQueryStringFromRelativeUrl(Uri possibleAppRelativeUri, out string queryString)
        {
            ...
            string appRelativeUrl = possibleAppRelativeUri.OriginalString;
