...
namespace PaymentService.Concrete
{
    public class GarantiBankPayment :PaymentServiceBase
    {
        ...
        public override PaymentMessage PeymentCore(BankRequest bankRequest, KrediKart krediKart)
        {
            PaymentMessage mesaj = new PaymentMessage();

            string strMode = "PROD"; // gerçek ortam 
            string strVersion = "v0.01";
            string strTerminalID = "10008052"; //8 Haneli TerminalID yazılmalı.
            ...
            string strOrderID = krediKart.SiparisNo;
            string strNumber = krediKart.No.Trim();
            string strExpireDate = krediKart.Ay + krediKart.Yil.Substring(2);
            string strCVV2 = krediKart.CV2.Trim();
            ...
            char crNull = ' ';
            string adSoyad = krediKart.AdSoyad.Trim();
            ...
            try
            {
                ...
                XmlElement ReasonCode = xDoc.SelectSingleNode("//GVPSResponse/Transaction/Response/ReasonCode") as XmlElement;
                XmlElement Message = xDoc.SelectSingleNode("//GVPSResponse/Transaction/Response/Message") as XmlElement;
