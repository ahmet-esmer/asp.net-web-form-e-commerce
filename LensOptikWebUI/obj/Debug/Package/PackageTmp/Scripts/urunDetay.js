...
$(document).ready(function () {
    ...
    $('#imgSepetGoruntu').click(function () {
        ...
        if ($("#hdfUyeId").val() > 0) {
            window.location.href = sSitePath + "Market/Sepet.aspx";
        }
        else {
            window.location.href = sSitePath + "Kullanici/Kayit.aspx?sepet=0&returnUrl=" + $('#hdfGeridonusUrl').val();
        }
    });
    ...
    $('#imgFavoriEkle').click(function () {
        if ($("#hdfUyeId").val() > 0) {
            ...
            window.location.href = sSitePath + "Kullanici/Kayit.aspx?returnUrl=" + $('#hdfGeridonusUrl').val();
        }
    });
    ...
    $('#imgSepeteEkle').click(function () {
        ...
        if ($("#hdfUyeId").val() > 0) {
            post(sSitePath + "Market/Sepet.aspx", prm);
        }
        else {
            post( sSitePath + "Kullanici/Kayit.aspx?sepeteEkle=0", prm);
        }
    });
});
