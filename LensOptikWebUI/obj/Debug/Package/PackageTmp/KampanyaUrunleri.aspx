<%@ Page Language="C#" ViewStateMode="Disabled" MasterPageFile="~/Site.master" AutoEventWireup="true" Inherits="kampanya_urunler" Codebehind="KampanyaUrunleri.aspx.cs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphContent" Runat="Server">
   ...
   <div id="ortaDis">
      ...
      <asp:HyperLink ID="hlkat3" CssClass="altMenu" NavigateUrl="~/Kampanyalar.aspx"  Text="Kampanyalar" ClientIDMode="Static" runat="server">
      </asp:HyperLink>
      <asp:HyperLink ID="hlKampanya" rel="nofollow" CssClass="altMenu"  ClientIDMode="Static" runat="server">
      </asp:HyperLink>
