<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="True" Inherits="Kullanici_Favori" Codebehind="Favoriler.aspx.cs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphContent" Runat="Server">
    ...
    <div id="ortaSag">
        ...
        AutoGenerateColumns="false" CellPadding="4" ForeColor="#333333"  GridLines="None" Width="100%"  DataKeyNames="favoriId" onrowcommand="grwKulaniciFavoriler_RowCommand" 
        PageSize="10" OnPageIndexChanging="gvwListe_Paging" AllowPaging="True"   >
                    ...
                    <asp:Image ID="img" ImageUrl='<%# "~/Products/Little/"+ Eval("resimAdi").ToString() %>'
                     ClientIDMode="Static"  runat="server"   CssClass="sepetResim" />
                       ...
                       CommandName="favoriSil"
                       CommandArgument='<%# DataBinder.Eval(Container, "DataItem.favoriId")%>' 
                       OnClientClick="return confirm('Bu Favori Ürününü silmek istediğinizden emin misiniz?');"
                       runat="server" />
                            </ItemTemplate>
