...
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" Runat="Server">
     ...
     <script type="text/javascript" src="<%# ResolveUrl("~/Scripts/fancyzoom.js") %>" ></script>
</asp:Content>
 ...
 <!-- Günün ürünü -->
  ...
  <div id="kayitIc" onkeypress="javascript:return WebForm_FireDefaultButton(event, 'btnUyeKayit')" > 
     <table class="uyuTablo">
            ...
            <tr>
                ...
                <td>
                    <asp:Button ID="btnUyeKayit"  ValidationGroup="yeniKayit" Width="150px" runat="server" Text="Bilgileri Kaydet" 
                        onclick="btnUyeKayit_Click" ClientIDMode="Static" CssClass="button" /> <br /> <br /> <br />
                </td>
         ...
         <a href="#hediye_box" id="hlGizlilikPolitikasi" style=" color: #DD003E;">
                      Gizlilik Politikası
                    </a>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#hlGizlilikPolitikasi').fancyZoom({ width: 500, height: 100 });

        $("#btnUyeKayit").click(function () {
